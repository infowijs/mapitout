...
const reduceSetNewTravelTimeDetails = (
  state: State,
  action: SetNewTravelTimeDetails
) => {
  return {
    ...state,
...
const reduceSetPrimaryEducationVisibility = (
  state: State,
  action: SetPrimaryEducationVisibility
) => {
  return {
    ...state,
...
const reduceSetSecondaryEducationVisibility = (
  state: State,
  action: SetSecondaryEducationVisibility
) => {
  return {
    ...state,
...
const reduceSetOnlyInternationalVisibility = (
  state: State,
  action: SetOnlyInternationalVisibility
) => {
  return {
    ...state,
