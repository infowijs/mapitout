...
class Root extends React.Component<{}, { loaded: boolean }> {
  ...
  public componentDidMount(): void {
    scriptjs(
      `https://maps.googleapis.com/maps/api/js?v=3&key=${process.env.REACT_APP_GOOGLE_MAPS_TOKEN}&v=3.exp&libraries=geometry,drawing,places`,
      ...
      <I18nProvider language={i18n.language} i18n={i18n}>
        <Provider store={store}>
          ...
          <BrowserRouter>
            <Route
              component={App}
              path="/:travelOne?/:travelTwo?/:travelThree?/:travelFour?/:travelFive?/:travelSix?"
            />
          </BrowserRouter>
        </Provider>
      </I18nProvider>
